...
void handleNetworking(Tid parent)
{
    ...
    for (bool active = true; active;)
    {
        ...
        auto recv = receiveTimeout(TIMEOUT_DUR, // (bool noSendRequested) { writeln("explicit no send"); },
            ...
            if (needToSend)
            {
                network.sendToServer(commandToSend);
            }
        ...
        while (runApplication)
        {
            ...
            while (SDL_PollEvent(&e) != 0)
            {
                ...
                else if (e.type == SDL_MOUSEMOTION && drawing)
                {
                    ...
                    DrawPixelCommand newDrawPixelCommand = new DrawPixelCommand(xPos,
                            yPos, lineColor);
            ...
            SDL_BlitSurface(applicationState.canvasState.cachedImgSurface,
                    null, SDL_GetWindowSurface(window), null);
